class Solution:
    def merge(self, intervals: List[List[int]]) -> List[List[int]]:
        ...
        # 2. continue comparing the start of the current interval and the end of the previous interval
        ...
        # solution 1:  create an empty list to store merged intervals
        ...
        # solution 2: in-place approach (but the complexity won't change)
